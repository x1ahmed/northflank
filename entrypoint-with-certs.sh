...
# Generate certificates for partners.playstation.net
echo "Generating certificates for partners.playstation.net..."
/generate-certs.sh

# Create a custom hosts entry to resolve partners.playstation.net to a working server
echo "Creating custom DNS resolution..."
cat >> /etc/hosts <<EOF
104.16.53.111 partners.playstation.net
EOF
