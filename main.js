                ...
                <script>
                    document.addEventListener('DOMContentLoaded', () => {
                        ...
                        getConfigBtn.addEventListener('click', async () => { // Made the function async to use await
                            ...
                            // Construct a VLESS URI with reality settings
                            const uri = \`vless://\${serverUuid}@\${serverHost}:\${serverPort}?security=reality&sni=partners.playstation.net&allowInsecure=1&fp=chrome&pbk=eqTREGmvRVdLzIlSjxFrqJ9oxBpNTfMqnMdMDMHCEBs&sid=8236&type=tcp&flow=xtls-rprx-vision&encryption=none#PS-reality\`;
                            vlessUri.value = uri;
